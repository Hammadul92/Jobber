...
function CTASection() {
    return (
        <section className="w-full py-28 px-32 rounded-3xl flex flex-col items-center text-center gap-6">
            <div className='min-w-6xl bg-cover bg-no-repeat bg-center border-2 border-accent rounded-3xl px-10 py-28 flex flex-col items-center gap-8' style={{ backgroundImage: `url(../../public/images/CTA-Gradient.svg)` }}>
