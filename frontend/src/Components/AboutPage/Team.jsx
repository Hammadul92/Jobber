      ...
      <div className="min-w-[48%] flex-1 space-y-6 md:space-y-8">
        <div className="space-y-4">
          ...
          <p className="leading-relaxed text-gray-600 md:text-2xl">
            We aren&apos;t just developers; we are partners in your growth. Our
            team is composed of industry veterans and tech experts united by a
            single goal making your life easier.
          </p>
          <p className="leading-relaxed text-gray-600 md:text-2xl">
            We understand the late nights finishing quotes and the weekends lost
            to bookkeeping. That&apos;s why every feature in Contractorz is
        ...
        <ul className="space-y-3">
          {highlights.map((item) => (
            <li
              key={item}
              className="flex items-start gap-3 text-base font-semibold text-gray-900 md:text-lg"
            >
              <FiCheckCircle
                className="mt-1 h-5 w-5 text-gray-700"
                aria-hidden="true"
              />
              <span>{item}</span>
            </li>
