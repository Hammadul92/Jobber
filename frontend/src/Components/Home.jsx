    ...
    <div>
      ...
      <section className="bg-light py-5 text-center">
        <div className="container">
          ...
          <div className="mt-4">
            <a href="#contact" className="btn btn-primary btn-lg me-2">Get Started</a>
            <a href="#contact" className="btn btn-success btn-lg">Book a Demo</a>
          </div>
        </div>
      </section>
      ...
      <section className="py-5">
        <div className="container text-center">
          ...
          <div className="row">
            {[
              { icon: "fa-broom", text: "Cleaning Companies", img: cleaning_image },
              { icon: "fa-seedling", text: "Landscaping & Lawn Care", img: landscaping_image },
              { icon: "fa-wrench", text: "Plumbing & Electrical", img: plumbing_image },
              { icon: "fa-hard-hat", text: "Renovations & Contractors" },
            ].map((item, i) => (
      ...
      <section className="py-5 bg-light">
        <div className="container text-center">
          ...
          <div className="row">
            {[
              { icon: "fa-calendar-check", title: "Job Scheduling", desc: "Drag & drop calendar to assign and track jobs." },
              { icon: "fa-file-invoice-dollar", title: "Invoicing & Payments", desc: "Create branded invoices and get paid faster." },
              { icon: "fa-users", title: "Client Management", desc: "Keep all customer details in one place." },
              { icon: "fa-mobile-screen-button", title: "Mobile App", desc: "Empower your field staff with mobile job updates." },
            ].map((feature, i) => (
      ...
      <section className="py-5">
        <div className="container text-center">
          ...
          <div className="row">
            {[
              { icon: "fa-tags", title: "Affordable Pricing", desc: "Transparent plans with no hidden fees." },
              { icon: "fa-gears", title: "Customizable Workflows", desc: "Adapt the platform to your business needs." },
              { icon: "fa-headset", title: "Dedicated Support", desc: "Friendly local support team ready to help." },
              { icon: "fa-bolt", title: "Fast & Easy", desc: "Modern design that your team can learn quickly." },
            ].map((item, i) => (
              <div key={i} className="col-md-3 mb-4 text-center">
