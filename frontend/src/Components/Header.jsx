...
export default function Header() {
  ...
  const { data: user, isFetching: isFetchingUser } = useFetchUserQuery(
    undefined,
    { skip: !token },
  );
  ...
  const mobLinkClass = (path) => {
    const isActive = location.pathname === path;
    return (
      isActive ? "font-bold bg-secondary text-white px-8 py-5" : ""
    ).trim();
  };
  ...
  return (
    <>
      ...
      <header
        id="site-header"
        className="fixed top-9 left-0 z-30 flex items-end md:items-center justify-between bg-background px-6 pt-2 md:pt-4 md:px-16 lg:px-32 w-full transition-[top] duration-150 ease-in-out"
      >
        {/* Mobile Menu Button */}
        ...
        {mobileNavOpen && (
          <div
            className="fixed inset-0 w-full h-screen bg-black/50"
            ...
            >
              ...
              <nav className="flex flex-col items-start justify-start font-medium">
                <Link
                  ...
                  to="/"
                  className={
                    "w-full text-lg text-left px-8 py-5" + mobLinkClass("/")
                  }
                >
                  Home
                </Link>
                ...
                <div
                  className={
                    "w-full text-lg text-left px-8 py-5 flex items-center justify-between" +
                    mobLinkClass("/industries")
                  }
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                {showMobileIndustries && (
                  <div className="pl-14 pb-2">
                    ...
                    <Link
                      to="/industries"
                      className={
                        "text-secondary font-semibold flex items-center gap-1 hover:underline mb-2"
                      }
                      onClick={() => {
                        setMobileNavOpen(false);
                ...
                <Link
                  ...
                  to="/faqs"
                  className={
                    "w-full text-lg text-left px-8 py-5" + mobLinkClass("/faqs")
                  }
                >
                  FAQ's
                </Link>
                <Link
                  ...
                  to="/about"
                  className={
                    "w-full text-lg text-left px-8 py-5" +
                    mobLinkClass("/about")
                  }
                >
                  About Us
        ...
        <nav className="hidden lg:flex items-center md:text-lg gap-x-10 lg:mt-2 font-medium">
          ...
          <div className="relative inline-block">
            ...
            >
              Industries
              {showMegaMenu ? (
                <FaChevronUp className="inline-flex ml-1 text-xs" />
              ) : (
                <FaChevronDown className="inline-flex ml-1 text-xs" />
              )}
            </button>
            {/* Mega Menu */}
            {showMegaMenu && (
          ...
          <Link to="/" onClick={handlePricingClick}>
            Pricing
          </Link>
