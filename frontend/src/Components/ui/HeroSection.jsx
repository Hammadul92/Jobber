...
function HeroSection({ children }) {
    return (
        <section className='relative bg-background overflow-hidden lg:min-h-screen md:h-fit lg:h-screen w-full px-6 py-40 md:px-16 lg:px-32 md:py-34 flex flex-col items-center justify-start gap-3'>
