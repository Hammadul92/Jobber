...
function HeroSection({ children }) {
  return (
    <section className="relative bg-background overflow-hidden lg:min-h-screen md:h-fit lg:h-screen w-full px-6 py-40 md:px-16 lg:px-32 md:py-34 flex flex-col items-center justify-center gap-3">
      {/* Design Elements */}
      ...
      <div className="absolute w-20 h-20 bottom-18 right-10 md:w-24 md:h-24 lg:w-auto lg:h-auto md:bottom-18 md:right-16 lg:bottom-28 lg:right-70">
