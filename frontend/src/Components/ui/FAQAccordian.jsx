...
function FAQAccordian({ items, defaultOpenIndex = 0 }) {
  ...
  return (
    <section className="z-20 w-full px-6 md:px-16 lg:px-32">
      <div className="max-w-4xl mx-auto">
        {items.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="border-b border-[rgba(255,255,255,0.08)] py-6"
            >
              <button
                type="button"
              ...
              >
                <h3
                  className={`text-xl font-intro ${isOpen ? "text-accent" : "text-white"}`}
                >
                  {item.question}
                </h3>
