    ...
    <HeroSection>
      ...
      <div className="absolute z-0 top-80 md:top-40 lg:bottom-0 md:-left-10 lg:-left-20 rotate-90 lg:-rotate-[6.5deg]">
        <img
          src={DotsBg}
          alt="Design Element"
          className="scale-150 md:scale-[1.5] lg:scale-[1.2]"
        />
      </div>
      ...
      <div className="z-1 md:mb-8 lg:mb-6 flex items-center gap-2 bg-accent/20 rounded-full px-3 py-1 md:px-5 md:py-2.5 border border-accent">
        ...
        <div>
          <div>
            <FaStar
              className="w-3 md:w-4 inline-block mr-0.5 text-accent"
              size={16}
            />
            <FaStar
              className="w-3 md:w-4 inline-block mr-0.5 text-accent"
          ...
          <p className="text-black/60 text-[0.65rem] md:text-sm">
            115+ Happy Clients
          </p>
        </div>
      </div>
      ...
      <div className="z-1 flex flex-col items-center gap-5 md:max-w-7xl mt-4">
        ...
        <p className="text-center md:px-28 md:text-xl lg:text-2xl section-intro md:mt-2">
          Empower your HR team with our all-in-one SaaS platform, designed to
          streamline your entire hiring process from attracting top talent to
          seamless onboarding.
        </p>
      </div>
      ...
      <div className="relative z-1 mt-4 md:mt-2">
        ...
        >
          ...
          <FaArrowRight className="inline-block ml-2" size={22} />
        </button>
      </div>
    </HeroSection>
  );
