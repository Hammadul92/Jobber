    ...
    >
      <div className="max-w-6xl">
        <h2 className="font-heading text-xl md:text-2xl lg:text-3xl max-w-2xl lg:pr-60 font-bold leading-relaxed lg:leading-[1.6] text-white">
          Supporting home service businesses across{" "}
          <span className="text-accent">50+ industries</span>.
        </h2>
        ...
        <div className="mt-20 flex flex-col items-center gap-3">
          <Link
            to="/services"
            className="rounded-full bg-accent px-8 py-3 font-semibold text-white shadow-lg shadow-orange-500/30"
          >
            Explore all 50+ services{" "}
            <FiChevronRight className="ml-1 inline-flex h-6 w-6" />
          </Link>
