...
function TrustedBy() {
  return (
    <section className="px-6 py-10 md:py-20 md:px-16 lg:px-0 bg-white border-b border-gray-200">
      <h2 className="text-3xl md:text-4xl font-extrabold text-[#101828] text-center mb-12">
      ...
      <div className="flex items-center justify-start flex-wrap lg:flex-nowrap overflow-hidden gap-5 lg:pl-32">
        ...
        <div className="w-full lg:min-w-4/11 bg-white rounded-2xl border border-[#e5eaf1] p-8 flex flex-col gap-4">
          ...
          <div className="text-primary text-lg md:text-xl font-medium">
            “Contractorz helped us cut admin time in half. Scheduling and
            invoicing are finally under control.”
          </div>
          <div className="flex items-center gap-3 mt-4">
            <span className="w-10 h-10 rounded-full bg-[#e5eaf1] flex items-center justify-center text-[#64748b] font-bold text-lg">
              BO
            </span>
            <div>
              <div className="font-semibold text-[#101828] text-sm md:text-base">
                Business Owner
              </div>
        ...
        <div className="w-full lg:min-w-4/11 bg-white rounded-2xl border border-[#e5eaf1] p-8 flex flex-col gap-4">
          ...
          <div className="text-primary text-lg md:text-xl font-medium">
            “We look more professional, get paid faster, and our crews are
            always aligned. It's a game changer.”
          </div>
          <div className="flex items-center gap-3 mt-4">
            <span className="w-10 h-10 rounded-full bg-[#e5eaf1] flex items-center justify-center text-[#64748b] font-bold text-lg">
              LC
