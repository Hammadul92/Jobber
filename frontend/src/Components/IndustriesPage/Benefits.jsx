...
function Benefits() {
  return (
    <section className="px-6 py-10 md:py-20 md:px-16 lg:px-32 bg-background">
      <h2 className="text-2xl lg:text-3xl font-extrabold text-primary md:mb-2">
        The real benefits for your team
      </h2>
      <p className="text-gray-500 md:text-lg mb-10">
        Simplify operations so you can focus on the field.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-8 flex flex-col gap-3">
          ...
          <div className="text-gray-500 text-base">
            Automate quoting, scheduling, and invoicing so admin work doesn’t
            eat your evenings.
          </div>
        </div>
        {/* Card 2 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-8 flex flex-col gap-3">
          ...
          <div className="text-gray-500 text-base">
            Clear schedules and job details keep crews aligned and customers
            informed.
          </div>
        </div>
        {/* Card 3 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-8 flex flex-col gap-3">
          ...
          <div className="text-gray-500 text-base">
            Send invoices instantly and accept online payments without
            follow-ups.
          </div>
        </div>
        {/* Card 4 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-8 flex flex-col gap-3">
          ...
          <div className="text-gray-500 text-base">
            Branded quotes, invoices, and client communication build trust from
            day one.
          </div>
        </div>
        {/* Card 5 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5 md:p-8 flex flex-col gap-3">
          <div className="bg-background w-12 h-12 flex items-center justify-center rounded-lg mb-2">
            ...
            >
              <rect x="3" y="3" width="18" height="18" rx="4" />
              <path d="M8 16v-4m4 4v-7m4 7v-2" />
            </svg>
          </div>
          <div className=" text-xl text-[#101828]">Run a Scalable Business</div>
          <div className="text-gray-500 text-base">
            Whether you have one crew or ten, Contractorz grows with you.
          </div>
        </div>
      </div>
    </section>
