        ...
        <>
            <div className='space-y-10'>
                <div className='flex items-start justify-between'>
                    <div>
                        <h2 className="text-3xl md:text-4xl font-bold mb-1">Banking & Payments</h2>
                ...
                {hasBusiness && (
                    <div className='rounded-2xl bg-white shadow-md '>
                        ...
                        <div className='flex flex-wrap md:flex-nowrap items-start justify-between p-4 md:p-10'>
                            ...
                            <div className={`border ${!activeBank ? 'border-gray-200 bg-gray-100' : !activeBank?.account_number_last4 ? 'border-amber-200 bg-amber-100' : 'border-green-300 bg-green-100'} px-3 pb-0.5 ml-10 md:ml-0 mt-2 md:mt-0 lg:pt-1 lg:pb-1.5 rounded-full`}>
                        ...
                        <div className='border-t border-gray-200 p-4 md:px-10 md:py-8'>
                            ...
                            <div className="rounded-xl border border-amber-100 bg-amber-50 p-3 md:p-8 text-amber-800 font-light flex items-start gap-3 mt-8">
                                ...
                                <div>
                                    ...
                                    <p className='md:text-lg mt-1'>For a $100.00 transaction, you'll receive <span className='font-semibold'>$96.80</span>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='border-t border-gray-200 px-4 py-8 md:px-10 lg:py-16 flex flex-col items-center'>
                        {!activeCard ? (
                            <>
                                ...
                                <h3 className='text-xl md:text-2xl font-bold my-2 text-center'>No payment method added yet</h3>
                                <p className='max-w-xs w-84 text-gray-400 md:text-lg text-center'>Add a credit or debit card to pay for your platform subscription and transaction fees.</p>
                                <button
                                    type="button"
                                    onClick={() => setShowCardForm(true)}
