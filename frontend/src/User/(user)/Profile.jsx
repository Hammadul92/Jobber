...
export default function Profile({ token, setAlert }) {
  ...
  const handlePhotoChange = (e) => {
    ...
    if (
      ...
      setAlert({
        type: "danger",
        message: "Invalid file. Please upload JPG or PNG under 5MB.",
      });
    }
  };
  ...
  return (
    <div>
      <div>
        <h2 className="text-3xl md:text-4xl font-bold md:mb-1">
      ...
      >
        ...
        <div className="text-center md:text-left">
          <span className="block text-orange-500 font-semibold text-lg mb-1">
            Change Photo
          </span>
