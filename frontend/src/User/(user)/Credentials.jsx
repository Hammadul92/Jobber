    ...
    <div className="space-y-5 md:space-y-10">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-gray-500">
            Manage your password settings and account security preferences.
          </p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-4 hidden md:flex items-center justify-between gap-2">
          ...
          <div>
            ...
            <p className="text-[#4F39F6] font-semibold text-sm">
              Enhanced Security
            </p>
          </div>
        </div>
      ...
      <div className="space-y-3 rounded-2xl bg-white p-4 md:p-10 shadow">
        <div>
          ...
          <p className="text-gray-400 mb-5 md:mb-10 mt-1.5 md:text-lg">
            Your password must meet the following criteria to ensure maximum
            security.
          </p>
        </div>
        <ul className="space-y-3 text-lg">
          <li
            className={`flex items-center gap-2 ${passwordRules.length ? "text-green-600" : "text-gray-400"}`}
          >
          ...
          <li
            className={`flex items-center gap-2 ${passwordRules.uppercase ? "text-green-600" : "text-gray-400"}`}
          >
          ...
          <li
            className={`flex items-center gap-2 ${passwordRules.number ? "text-green-600" : "text-gray-400"}`}
          >
          ...
          <li
            className={`flex items-center gap-2 ${passwordRules.special ? "text-green-600" : "text-gray-400"}`}
          >
      ...
      <form
        ...
        className="space-y-5 md:space-y-10 rounded-2xl bg-white p-4 md:p-10 shadow"
      >
        <div>
          <h5 className="text-2xl font-semibold text-gray-900">
            Update Password
        ...
        <div className="mb-3 md:mb-6">
          <label
            htmlFor={"newPassword"}
            className="mb-1 block font-semibold text-gray-400 uppercase"
          >
      ...
      <div className="mt-10 p-3 pt-10 flex flex-col md:flex-row items-start justify-between gap-2 md:gap-0 border-t border-gray-300 text-gray-400">
        <div className="md:space-y-1 font-bold">
          <p className="text-semibold tracking-wider text-sm md:text-base">
