...
export default function CreateServiceQuestionnairesForm({
  ...
  return (
    <div
      className="fixed inset-0 z-50 h-screen flex items-center justify-center bg-black/50 px-3"
    ...
    >
      ...
      >
        <div className="flex items-start justify-between bg-secondary rounded-t-2xl border-b border-gray-200 p-6">
          <div>
            <h5 className="text-xl font-semibold font-heading text-white">
              Create Service Questionnaire
            </h5>
            <p className="text-xs font-medium uppercase tracking-[0.08em] text-gray-100">
              Questionnaire
            </p>
          </div>
          <button
