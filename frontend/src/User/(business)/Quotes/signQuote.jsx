        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-600">
                ...
                <li>
                  ...
                  {quote.client?.client_email || "_"}
                </li>
                <li>
                  <strong className="text-gray-800">Phone:</strong>{" "}
                  {quote.client?.client_phone || "_"}
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ul className="space-y-1 text-sm text-gray-600">
                <li>
                  <strong className="text-gray-800">Service Name:</strong>{" "}
                  {quote.service_data?.service_name || "—"}
                </li>
                <li>
                ...
                <li>
                  ...
                  {quote.service_data?.price} {quote.service_data?.currency}
                </li>
                ...
                <li>
                  <strong className="text-gray-800">Billing Cycle:</strong>{" "}
                  {quote.service_data?.billing_cycle || "—"}
                </li>
                <li>
                ...
                <li>
                  <strong className="text-gray-800">Service Address:</strong>{" "}
                  {quote.service_data?.street_address || "_"},{" "}
                  {quote.service_data?.city || "_"},{" "}
                  {quote.service_data?.country || "_"},{" "}
          ...
          <div className="space-y-4">
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                Object.keys(quote.service_data.filled_questionnaire).length >
                  0 ? (
                  Object.entries(quote.service_data.filled_questionnaire).map(
                    ([q, a]) => (
          ...
          {isFinalized ? (
                ...
                <p className="text-sm">
                  ...
                  {quote.signed_at && (
                    <>
                      ...
                      on{" "}
                      <strong>
                        {new Date(quote.signed_at).toLocaleString()}
                      </strong>
                    </>
                  )}
                </p>
            ...
            <div className="mt-3 flex justify-end gap-3">
              ...
              <button
                ...
                disabled={
                  signing || timeRemaining === "Expired" || status !== "SENT"
                }
              >
                Accept & Sign
              </button>
