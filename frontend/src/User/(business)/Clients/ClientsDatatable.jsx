    ...
    <>
      ...
      <div className="mb-4 grid grid-cols-1 gap-3 md:grid-cols-3">
        {stats.map(({ label, value }) => (
          <div
            key={label}
            className="rounded-xl border border-gray-100 bg-white/90 p-px shadow-sm"
          >
            <div className={`rounded-xl bg-secondary p-4 text-white`}>
              <p className="text-xs font-semibold uppercase tracking-[0.06em] text-white/80">
                {label}
              </p>
        ...
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center mt-18 gap-2 px-6 py-10 text-center">
            ...
            <p className="max-w-md text-sm text-gray-600">
              Start by adding a client. We will create their portal credentials
