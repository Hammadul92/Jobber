...
export default function SignIn() {
  ...
  const { data: userData, isSuccess: userFetched } = useFetchUserQuery(
    undefined,
    {
    ...
    <section className="min-h-screen w-full px-6 py-40 md:px-16 lg:px-32 md:py-24 flex flex-col items-center justify-center">
      <div className="max-w-xl mx-auto text-center">
        ...
        <p className="text-gray-600">
          Access your workspace and keep your projects moving.
        </p>
      </div>
      ...
      >
        <div className="w-full max-w-none md:max-w-xl bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100">
          {signinError && (
          ...
          <Input
            ...
            onChange={setEmail}
            fieldClass={
              "w-full rounded-xl border border-gray-200 px-4 py-3 text-base focus:outline-none focus:ring focus:ring-accent focus:border-accent transition bg-white"
            }
          />
