    ...
    <section className="min-h-screen w-full px-6 py-40 md:px-16 lg:px-32 md:py-24 flex flex-col items-center justify-center">
      <div className="mx-auto">
        ...
        <p className="text-center text-gray-600 mb-10">
          Join our community and start managing your work with a secure, modern
          workspace.
        </p>

        <div className="grid gap-8 lg:grid-cols-2 w-full">
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100">
            <h5 className="text-xl font-semibold text-secondary mb-4">
              Password Requirements
            </h5>
            <ul className="space-y-3 text-base">
              <li
                className={`flex items-center ${passwordRules.length ? "text-green-600" : "text-gray-500"}`}
              >
              ...
              <li
                className={`flex items-center ${passwordRules.uppercase ? "text-green-600" : "text-gray-500"}`}
              >
              ...
              <li
                className={`flex items-center ${passwordRules.number ? "text-green-600" : "text-gray-500"}`}
              >
              ...
              <li
                className={`flex items-center ${passwordRules.special ? "text-green-600" : "text-gray-500"}`}
              >
            ...
            <p className="text-sm text-gray-500 mt-4 text-center">
              Your password must satisfy all of the above to be considered
              strong.
            </p>
            <div className="mt-6 grid grid-cols-2 gap-4 text-sm text-gray-600">
              <div className="rounded-xl bg-slate-50 border border-gray-100 p-4">
                ...
                <p>
                  Add a phrase you remember plus a symbol, e.g., Coffee@Dawn24.
                </p>
              </div>
              <div className="rounded-xl bg-slate-50 border border-gray-100 p-4">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 sm:p-8 border border-gray-100">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Input
                ...
                onChange={setName}
                fieldClass={
                  "w-full rounded-xl border border-gray-200 px-4 py-3 text-base focus:ring-2 focus:ring-accent focus:border-accent transition bg-white"
                }
              />
